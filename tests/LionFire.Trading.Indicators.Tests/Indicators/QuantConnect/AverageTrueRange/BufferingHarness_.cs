...
public class HistoricalHarness_ : BinanceDataTest
{
    ...
    {
        var h = new BufferingIndicatorHarness<AverageTrueRange<double>, PAverageTrueRange<double>, IKline, double>(ServiceProvider, new(new PAverageTrueRange<double>
        {
            MovingAverageType = QuantConnect.Indicators.MovingAverageType.Simple,
            Period = 14,
        })
    ...
    {
        var h = new BufferingIndicatorHarness<AverageTrueRange<float>, PAverageTrueRange<float>, IKline, float>(ServiceProvider, new(new PAverageTrueRange<float>
        {
            MovingAverageType = QuantConnect.Indicators.MovingAverageType.Simple,
            Period = 14,
        })
