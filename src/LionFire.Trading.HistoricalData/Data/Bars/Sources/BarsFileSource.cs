...
public class BarsSourceBase
{

}

public class BarsFileSource : BarsSourceBase, IBars, IChunkedBars, IBarFileSources, IListableBarsSource
{
    ...
    public Task<BarsAvailable> List(SymbolBarsRange range)
