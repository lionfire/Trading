...
/// Use BollingerBands_QC directly if you need the QuantConnect-specific implementation,
/// or BollingerBands_FP from LionFire.Trading.Indicators.Native for the first-party implementation.
/// 
...
/// </remarks>
public class BollingerBands<TInput, TOutput> : Native.BollingerBands_FP<TInput, TOutput>
    where TInput : struct
