...
/// <summary>
/// Abstract base class for Chaikin Money Flow implementations with common logic
/// </summary>
public abstract class ChaikinMoneyFlowBase<TInput, TOutput>
    : IChaikinMoneyFlow<TInput, TOutput>
    , IIndicator2<PChaikinMoneyFlow<TInput, TOutput>, TInput, TOutput>
    ...
    where TOutput : struct, INumber<TOutput>
{
    ...
    protected PChaikinMoneyFlow<TInput, TOutput> Parameters { get; }

    public int Period => Parameters.Period;
    
    public abstract TOutput CurrentValue { get; }
    
    public virtual bool IsBullish => IsReady && CurrentValue > TOutput.Zero;
    
    public virtual bool IsBearish => IsReady && CurrentValue < TOutput.Zero;

    public abstract TOutput MoneyFlowVolumeSum { get; }
    ...
    protected ChaikinMoneyFlowBase(PChaikinMoneyFlow<TInput, TOutput> parameters)
    {
    ...
    protected virtual void ValidateParameters()
    {
        if (Parameters.Period < 2)
            throw new ArgumentException("CMF period must be at least 2", nameof(Parameters.Period));
    }
