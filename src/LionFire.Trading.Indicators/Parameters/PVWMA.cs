...
/// <summary>
/// Shared parameters for all VWMA implementations
/// </summary>
public class PVWMA<TInput, TOutput> : IndicatorParameters<TInput, TOutput>
    where TInput : struct
    where TOutput : struct, INumber<TOutput>
{
    ...
    [JsonIgnore]
    public override string Key => $"VWMA({Period})";
