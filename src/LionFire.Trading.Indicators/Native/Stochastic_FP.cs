...
/// </summary>
public class Stochastic_FP<TPrice, TOutput>
    : StochasticBase<TPrice, TOutput>
    , IIndicator2<Stochastic_FP<TPrice, TOutput>, PStochastic<TPrice, TOutput>, HLC<TPrice>, TOutput>
    where TPrice : struct
    where TOutput : struct, INumber<TOutput>
{
    ...
    public static Stochastic_FP<TPrice, TOutput> Create(PStochastic<TPrice, TOutput> p)
        => new Stochastic_FP<TPrice, TOutput>(p);

    public Stochastic_FP(PStochastic<TPrice, TOutput> parameters) : base(parameters)
    {
