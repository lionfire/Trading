...
/// </summary>
public class SMAFP<TPrice, TOutput> : SingleInputIndicatorBase<SMAFP<TPrice, TOutput>, PSMA<TPrice, TOutput>, TPrice, TOutput>,
    IIndicator2<SMAFP<TPrice, TOutput>, PSMA<TPrice, TOutput>, TPrice, TOutput>,
    ISMA<TPrice, TOutput>
    where TPrice : struct
    where TOutput : struct, INumber<TOutput>
{
    ...
    /// </summary>
    public static SMAFP<TPrice, TOutput> Create(PSMA<TPrice, TOutput> p) => new SMAFP<TPrice, TOutput>(p);

    /// <summary>
    /// Initializes a new instance of the SMA indicator
    /// </summary>
    public SMAFP(PSMA<TPrice, TOutput> parameters)
    {
