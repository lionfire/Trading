...
/// </summary>
public class RSIFP<TPrice, TOutput>
    : RSIBase<TPrice, TOutput>
    , IIndicator2<RSIFP<TPrice, TOutput>, PRSI<TPrice, TOutput>, TPrice, TOutput>
    where TPrice : struct
    where TOutput : struct, INumber<TOutput>
{
    ...
    public static RSIFP<TPrice, TOutput> Create(PRSI<TPrice, TOutput> p)
        => new RSIFP<TPrice, TOutput>(p);

    public RSIFP(PRSI<TPrice, TOutput> parameters) : base(parameters)
    {
