...
/// </summary>
public class BollingerBandsFP<TInput, TOutput>
    : BollingerBandsBase<TInput, TOutput>
    , IIndicator2<BollingerBandsFP<TInput, TOutput>, PBollingerBands<TInput, TOutput>, TInput, TOutput>
    where TInput : struct
    where TOutput : struct, INumber<TOutput>
{
    ...
    public static BollingerBandsFP<TInput, TOutput> Create(PBollingerBands<TInput, TOutput> p)
        => new BollingerBandsFP<TInput, TOutput>(p);

    public BollingerBandsFP(PBollingerBands<TInput, TOutput> parameters) : base(parameters)
    {
