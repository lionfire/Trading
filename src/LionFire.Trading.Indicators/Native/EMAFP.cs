...
/// </summary>
public class EMAFP<TPrice, TOutput> : SingleInputIndicatorBase<EMAFP<TPrice, TOutput>, PEMA<TPrice, TOutput>, TPrice, TOutput>,
    IIndicator2<EMAFP<TPrice, TOutput>, PEMA<TPrice, TOutput>, TPrice, TOutput>,
    IEMA<TPrice, TOutput>
    where TPrice : struct
    where TOutput : struct, INumber<TOutput>
{
    ...
    /// </summary>
    public static EMAFP<TPrice, TOutput> Create(PEMA<TPrice, TOutput> p) => new EMAFP<TPrice, TOutput>(p);

    /// <summary>
    /// Initializes a new instance of the EMA indicator
    /// </summary>
    public EMAFP(PEMA<TPrice, TOutput> parameters)
    {
