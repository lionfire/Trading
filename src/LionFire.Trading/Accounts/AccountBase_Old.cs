...
namespace LionFire.Trading.Accounts
{
    ...
    public abstract class AccountBase_Old<TTemplate> : FeedBase<TTemplate>, IAccount_Old, ITemplateInstance, IFeed_Old
        where TTemplate : TAccount
    {
        ...
        string IAccount_Old.ExchangeName => Template?.Exchange;
        string IAccount_Old.AccountType => Template?.AccountType;

        TAccount IAccount_Old.Template { get { return Template; } }
        ...
        public AccountBase_Old(ILogger logger, ILoggerFactory loggerFactory) : base(logger)
        {
        ...
        {
            actor.Account = (IAccount_Old)this;
