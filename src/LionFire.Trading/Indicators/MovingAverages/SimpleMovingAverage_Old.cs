...
public sealed class SimpleMovingAverage_Old : SingleSeriesIndicatorBase<TSimpleMovingAverage>, IMovingAverageIndicator
{
    ...
    public SimpleMovingAverage_Old(TSimpleMovingAverage config) : base(config)
    {
