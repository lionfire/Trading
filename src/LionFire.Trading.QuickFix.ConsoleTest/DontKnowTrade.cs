...
namespace LionFire.Trading.QuickFix.ConsoleTest
{
    public class DontKnowTrade : Message
    {
        ...
        public DontKnowTrade(LionFire.Trading.QuickFix.ConsoleTest.Fields.OrderID aOrderID,
				LionFire.Trading.QuickFix.ConsoleTest.Fields.ExecID aExecID,
				LionFire.Trading.QuickFix.ConsoleTest.Fields.DKReason aDKReason,
        ...
        public LionFire.Trading.QuickFix.ConsoleTest.Fields.DKReason DKReason
        {
            get
            {
                var val = new LionFire.Trading.QuickFix.ConsoleTest.Fields.DKReason();
                GetField(val);
                return val;
            }
            set { SetField(value); }
        ...
        public void Set(LionFire.Trading.QuickFix.ConsoleTest.Fields.DKReason val) { this.DKReason = val; }

        public LionFire.Trading.QuickFix.ConsoleTest.Fields.DKReason Get(LionFire.Trading.QuickFix.ConsoleTest.Fields.DKReason val)
        {
            GetField(val);
            return val;
        }

        public bool IsSet(LionFire.Trading.QuickFix.ConsoleTest.Fields.DKReason val) { return IsSetDKReason(); }
