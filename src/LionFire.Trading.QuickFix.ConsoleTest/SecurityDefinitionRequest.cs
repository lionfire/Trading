...
namespace LionFire.Trading.QuickFix.ConsoleTest
{
    public class SecurityDefinitionRequest : Message
    {
        ...
        public SecurityDefinitionRequest(LionFire.Trading.QuickFix.ConsoleTest.Fields.SecurityReqID aSecurityReqID,
				LionFire.Trading.QuickFix.ConsoleTest.Fields.SecurityRequestType aSecurityRequestType)
               : this()
        {
        ...
        public LionFire.Trading.QuickFix.ConsoleTest.Fields.SecurityRequestType SecurityRequestType
        {
            get
            {
                var val = new LionFire.Trading.QuickFix.ConsoleTest.Fields.SecurityRequestType();
                GetField(val);
                return val;
            }
            set { SetField(value); }
        ...
        public void Set(LionFire.Trading.QuickFix.ConsoleTest.Fields.SecurityRequestType val) { this.SecurityRequestType = val; }

        public LionFire.Trading.QuickFix.ConsoleTest.Fields.SecurityRequestType Get(LionFire.Trading.QuickFix.ConsoleTest.Fields.SecurityRequestType val)
        {
            GetField(val);
            return val;
        }

        public bool IsSet(LionFire.Trading.QuickFix.ConsoleTest.Fields.SecurityRequestType val) { return IsSetSecurityRequestType(); }
