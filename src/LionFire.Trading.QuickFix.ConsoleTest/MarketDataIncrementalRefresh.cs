...
namespace LionFire.Trading.QuickFix.ConsoleTest
{
    public class MarketDataIncrementalRefresh : Message
    {
        ...
        public LionFire.Trading.QuickFix.ConsoleTest.Fields.MDUpdateAction MDUpdateAction
        {
            get
            {
                var val = new LionFire.Trading.QuickFix.ConsoleTest.Fields.MDUpdateAction();
                GetField(val);
                return val;
            }
            set { SetField(value); }
        ...
        public void Set(LionFire.Trading.QuickFix.ConsoleTest.Fields.MDUpdateAction val) { this.MDUpdateAction = val; }

        public LionFire.Trading.QuickFix.ConsoleTest.Fields.MDUpdateAction Get(LionFire.Trading.QuickFix.ConsoleTest.Fields.MDUpdateAction val)
        {
            GetField(val);
            return val;
        }

        public bool IsSet(LionFire.Trading.QuickFix.ConsoleTest.Fields.MDUpdateAction val) { return IsSetMDUpdateAction(); }

        public bool IsSetMDUpdateAction() { return IsSetField(Tags.MDUpdateAction); }

        public LionFire.Trading.QuickFix.ConsoleTest.Fields.DeleteReason DeleteReason
        {
            get
            {
                var val = new LionFire.Trading.QuickFix.ConsoleTest.Fields.DeleteReason();
                GetField(val);
                return val;
            }
            set { SetField(value); }
        ...
        public void Set(LionFire.Trading.QuickFix.ConsoleTest.Fields.DeleteReason val) { this.DeleteReason = val; }

        public LionFire.Trading.QuickFix.ConsoleTest.Fields.DeleteReason Get(LionFire.Trading.QuickFix.ConsoleTest.Fields.DeleteReason val)
        {
            GetField(val);
            return val;
        }

        public bool IsSet(LionFire.Trading.QuickFix.ConsoleTest.Fields.DeleteReason val) { return IsSetDeleteReason(); }
        ...
        public LionFire.Trading.QuickFix.ConsoleTest.Fields.MDEntryID MDEntryID
        {
            get
            {
                var val = new LionFire.Trading.QuickFix.ConsoleTest.Fields.MDEntryID();
                GetField(val);
                return val;
            }
            set { SetField(value); }
        ...
        public void Set(LionFire.Trading.QuickFix.ConsoleTest.Fields.MDEntryID val) { this.MDEntryID = val; }

        public LionFire.Trading.QuickFix.ConsoleTest.Fields.MDEntryID Get(LionFire.Trading.QuickFix.ConsoleTest.Fields.MDEntryID val)
        {
            GetField(val);
            return val;
        }

        public bool IsSet(LionFire.Trading.QuickFix.ConsoleTest.Fields.MDEntryID val) { return IsSetMDEntryID(); }

        public bool IsSetMDEntryID() { return IsSetField(Tags.MDEntryID); }

        public LionFire.Trading.QuickFix.ConsoleTest.Fields.MDEntryRefID MDEntryRefID
        {
            get
            {
                var val = new LionFire.Trading.QuickFix.ConsoleTest.Fields.MDEntryRefID();
                GetField(val);
                return val;
            }
            set { SetField(value); }
        ...
        public void Set(LionFire.Trading.QuickFix.ConsoleTest.Fields.MDEntryRefID val) { this.MDEntryRefID = val; }

        public LionFire.Trading.QuickFix.ConsoleTest.Fields.MDEntryRefID Get(LionFire.Trading.QuickFix.ConsoleTest.Fields.MDEntryRefID val)
        {
            GetField(val);
            return val;
        }

        public bool IsSet(LionFire.Trading.QuickFix.ConsoleTest.Fields.MDEntryRefID val) { return IsSetMDEntryRefID(); }
