...
/// </summary>
public class BollingerBandsQC<TInput, TOutput> : QuantConnectIndicatorWrapper<BollingerBandsQC<TInput, TOutput>, global::QuantConnect.Indicators.BollingerBands, PBollingerBands<TInput, TOutput>, TInput, TOutput>, 
    IIndicator2<BollingerBandsQC<TInput, TOutput>, PBollingerBands<TInput, TOutput>, TInput, TOutput>
    where TInput : struct
    where TOutput : struct, System.Numerics.INumber<TOutput>
{
    ...
    /// </summary>
    public static BollingerBandsQC<TInput, TOutput> Create(PBollingerBands<TInput, TOutput> p) => new BollingerBandsQC<TInput, TOutput>(p);

    /// <summary>
    /// Initializes a new instance of the Bollinger Bands indicator
    /// </summary>
    public BollingerBandsQC(PBollingerBands<TInput, TOutput> parameters) : base(
