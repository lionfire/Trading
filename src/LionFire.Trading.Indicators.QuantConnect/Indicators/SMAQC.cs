...
/// </summary>
public class SMAQC<TPrice, TOutput> : QuantConnectIndicatorWrapper<SMAQC<TPrice, TOutput>, global::QuantConnect.Indicators.SimpleMovingAverage, PSMA<TPrice, TOutput>, TPrice, TOutput>,
    IIndicator2<SMAQC<TPrice, TOutput>, PSMA<TPrice, TOutput>, TPrice, TOutput>,
    ISMA<TPrice, TOutput>
    where TPrice : struct
    where TOutput : struct, INumber<TOutput>
{
    ...
    /// </summary>
    public static SMAQC<TPrice, TOutput> Create(PSMA<TPrice, TOutput> p) => new SMAQC<TPrice, TOutput>(p);

    /// <summary>
    /// Initializes a new instance of the SMA indicator
    /// </summary>
    public SMAQC(PSMA<TPrice, TOutput> parameters) : base(
