...
/// </summary>
public class StochasticQC<TPrice, TOutput> : QuantConnectIndicatorWrapper<StochasticQC<TPrice, TOutput>, global::QuantConnect.Indicators.Stochastic, PStochastic<TPrice, TOutput>, HLC<TPrice>, TOutput>, 
    IIndicator2<StochasticQC<TPrice, TOutput>, PStochastic<TPrice, TOutput>, HLC<TPrice>, TOutput>
    where TPrice : struct
    where TOutput : struct, System.Numerics.INumber<TOutput>
{
    ...
    /// </summary>
    public static StochasticQC<TPrice, TOutput> Create(PStochastic<TPrice, TOutput> p) => new StochasticQC<TPrice, TOutput>(p);

    /// <summary>
    /// Initializes a new instance of the Stochastic indicator
    /// </summary>
    public StochasticQC(PStochastic<TPrice, TOutput> parameters) : base(
