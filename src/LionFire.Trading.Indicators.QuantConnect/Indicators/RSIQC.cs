...
/// </summary>
public class RSIQC<TPrice, TOutput> : QuantConnectIndicatorWrapper<RSIQC<TPrice, TOutput>, global::QuantConnect.Indicators.RelativeStrengthIndex, PRSI<TPrice, TOutput>, TPrice, TOutput>, 
    IIndicator2<RSIQC<TPrice, TOutput>, PRSI<TPrice, TOutput>, TPrice, TOutput>
{
    #region Static
    ...
    /// </summary>
    public static RSIQC<TPrice, TOutput> Create(PRSI<TPrice, TOutput> p) => new RSIQC<TPrice, TOutput>(p);

    /// <summary>
    /// Initializes a new instance of the RSI indicator
    /// </summary>
    public RSIQC(PRSI<TPrice, TOutput> parameters) : base(
