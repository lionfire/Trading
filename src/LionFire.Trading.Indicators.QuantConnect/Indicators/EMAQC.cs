...
/// </summary>
public class EMAQC<TPrice, TOutput> : QuantConnectIndicatorWrapper<EMAQC<TPrice, TOutput>, global::QuantConnect.Indicators.ExponentialMovingAverage, PEMA<TPrice, TOutput>, TPrice, TOutput>,
    IIndicator2<EMAQC<TPrice, TOutput>, PEMA<TPrice, TOutput>, TPrice, TOutput>,
    IEMA<TPrice, TOutput>
    where TPrice : struct
    where TOutput : struct, INumber<TOutput>
{
    ...
    /// </summary>
    public static EMAQC<TPrice, TOutput> Create(PEMA<TPrice, TOutput> p) => new EMAQC<TPrice, TOutput>(p);

    /// <summary>
    /// Initializes a new instance of the EMA indicator
    /// </summary>
    public EMAQC(PEMA<TPrice, TOutput> parameters) : base(
